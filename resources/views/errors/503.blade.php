...
<head>
    <title>TaliLeher.com - Maintenance</title>
    <meta charset="UTF-8">
...
<body class="bg-404">
    <section class="pd-5vw">
        ...
        <br>
        <div>
            <a href="https://wa.me/60174073135">WhatsApp</a> |
            <a href="https://www.facebook.com/inspirazs">Facebook</a>
        </div>
    </section>
    ...
    <section class="bottom-copy">
        ...
        <div>&copy; {{ date("Y") }} Inspirazs Sdn. Bhd.</div>
    </section>
